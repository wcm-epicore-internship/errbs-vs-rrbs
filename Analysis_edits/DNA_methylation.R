...
# (thk2008) look for myobj in R environment, if it's already loaded, yay, do nothing otherwise
# look for the saved data object and load it otherwise
# create it from the raw methylcall data files
if (!exists("myobj")) { 
